...
const template = require("./host-item-embed.component.html");
const styles = require("./host-item-embed.component.scss");

export class HostItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new HostDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new HostEdit(this.entity));
    }
...
customElements.define(`ce-host-item-embed`,HostItemEmbedComponent);
