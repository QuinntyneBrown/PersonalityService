...
const template = require("./house-guest-item-embed.component.html");
const styles = require("./house-guest-item-embed.component.scss");

export class HouseGuestItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new HouseGuestDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new HouseGuestEdit(this.entity));
    }
    ...
    public entity: HouseGuest;
}

customElements.define(`ce-house-guest-item-embed`,HouseGuestItemEmbedComponent);
