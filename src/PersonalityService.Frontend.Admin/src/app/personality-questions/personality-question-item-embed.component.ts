...
const template = require("./personality-question-item-embed.component.html");
const styles = require("./personality-question-item-embed.component.scss");

export class PersonalityQuestionItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new PersonalityQuestionDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new PersonalityQuestionEdit(this.entity));
    }
    ...
    public entity: PersonalityQuestion;
}

customElements.define(`ce-personality-question-item-embed`,PersonalityQuestionItemEmbedComponent);
