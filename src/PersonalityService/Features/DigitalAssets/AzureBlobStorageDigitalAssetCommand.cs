...
using PersonalityService.Features.DigitalAssets.UploadHandlers;
using System;
...
namespace PersonalityService.Features.DigitalAssets
{
    public class AzureBlobStorageDigitalAssetCommand
    {
        ...
        {
            public AzureBlobStorageDigitalAssetHandler(PersonalityServiceContext context, ICache cache, Lazy<IAzureBlobStorageConfiguration> lazyConfiguration)
            {
                _context = context;
                _cache = cache;
