...
using static PersonalityService.Features.Accounts.AddOrUpdateAccountCommand;
using static PersonalityService.Features.Accounts.GetAccountsQuery;
using static PersonalityService.Features.Accounts.GetAccountByIdQuery;
using static PersonalityService.Features.Accounts.RemoveAccountCommand;
