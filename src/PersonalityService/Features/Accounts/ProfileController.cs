...
using static PersonalityService.Features.Accounts.AddOrUpdateProfileCommand;
using static PersonalityService.Features.Accounts.GetProfilesQuery;
using static PersonalityService.Features.Accounts.GetProfileByIdQuery;
using static PersonalityService.Features.Accounts.RemoveProfileCommand;
