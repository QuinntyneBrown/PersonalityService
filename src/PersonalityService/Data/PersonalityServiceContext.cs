...
namespace PersonalityService.Data
{
    public interface IPersonalityServiceContext
    {
        ...
        DbSet<HouseGuest> HouseGuests { get; set; }
        DbSet<Host> Hosts { get; set; }

        Task<int> SaveChangesAsync();
    }

    public class PersonalityServiceContext: DbContext, IPersonalityServiceContext
    {
        public PersonalityServiceContext()
            :base("PersonalityServiceContext")
        {
        ...
        public DbSet<HouseGuest> HouseGuests { get; set; }
